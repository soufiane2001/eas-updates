  ...
  { key: 30, label: 'Pilote d avion' },
     ...
     const handleOptionChange = (option) => {
      ...
      const handleOptions = (option) => {
       ...
       navigation.navigate("Setupdepense",{budget:budgets,id:route.params.id,nom:route.params.nom,prenom:route.params.prenom,nom:route.params.nom,ville:route.params.ville,
      ...
      colors={['#FF5733', '#FFC300', '#36A2EB']}
       ...
       >
           ...
           <View style={{backgroundColor:'white',height:'80%',paddingTop:'7%',borderTopLeftRadius: getResponsiveFontSize(55),borderTopRightRadius:getResponsiveFontSize(55)}}>
                ...
                <TouchableOpacity   style={{marginTop:'2.5%',marginLeft:'5%',width:'10%',height:getResponsiveFontSize(35),resizeMode:"contain",marginRight:'1%'}} onPress={()=>{toggleModal2()}}>
 
 <Image 
        source={require('../../assets/cash.png')}
    style={{width:'100%',height:getResponsiveFontSize(35),resizeMode:"contain",marginRight:'1%'}}
 />
           ...
           <ScrollView style={{flex:1,marginTop:'4%',marginBottom:'2%',padding:'0%',paddingLeft:'1%',paddingRight:'1%',paddingVertical:'0%'}}>
