...
const Setupdepense=({navigation,route }) =>{
  ...
  {type:"Telephone",montant:0,depense:[],photo:'https://cdn-icons-png.flaticon.com/512/13/13936.png'},
  ...
  {type:"Electricite",montant:0,depense:[],photo:'https://cdn-icons-png.flaticon.com/512/2807/2807571.png'},
  {type:"vignette",montant:0,depense:[],photo:'https://cdn-icons-png.flaticon.com/512/744/744465.png'},
  {type:"Salle du sport",montant:0,depense:[],photo:'https://cdn-icons-png.flaticon.com/512/2216/2216769.png'},
]);
...
<Text style={{fontSize:getResponsiveFontSize(14),fontFamily:'PoppinsMedium',color:'black',textAlign:'center'}}>Svp Entrez vos montant des montants</Text>


<ScrollView style={{flex:1,marginTop:'7%',padding:'0%',paddingLeft:'1%',paddingRight:'1%',paddingVertical:'0%'}}>
...
<TouchableOpacity onPress={()=>{handleOptions()}}  style={{width:"25%",marginBottom:'2%',marginLeft:'70%',backgroundColor:'#4A83FE',paddingHorizontal:'2%',paddingVertical:'2%',borderRadius:25}}>
