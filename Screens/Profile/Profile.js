...
<Text style={{fontSize:getResponsiveFontSize(15),fontFamily:'PoppinsMedium',color:'#606060',marginLeft:'6.5%',marginTop:'4%'}}>info personnel :</Text>
...
<TextInput 
  ...
  <TouchableOpacity   style={{marginTop:'2.5%',marginLeft:'5%',width:'10%',height:getResponsiveFontSize(35),resizeMode:"contain",marginRight:'1%'}} onPress={()=>{toggleBudgetd()}}>
