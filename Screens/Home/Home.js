...
<Text style={{position:'absolute',top:'22%',left:'5%',zIndex:414,color:'#3E3E3E',fontSize:getResponsiveFontSize(14),fontFamily:'PoppinsRegular'}}>Tu as depensee ce mois  : 
...
<TouchableOpacity onPress={()=>{if(parseFloat(x.montant)>parseFloat(m)){ openModal(index,x.type)}}} style={{position:'absolute',zIndex:5565,left:'-2.5%'}}>
